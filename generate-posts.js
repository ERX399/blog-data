...
const SITE_DESC = "《夏之》是一个专注于IT/互联网技术分享与实践的个人技术博客，在这里你可以找到众多前沿技术的分享与实践经验。";
const AUTHOR_NAME = "夏之";
const AUTHOR_EMAIL = "e.r.x399@gmail.com";
...
// WebP 文件由 convert-to-webp.js 在 CI 构建期产出并部署到 raw-posts.520pro.top，
...
// raw-posts.520pro.top/seo/posts/<slug> 直接取用，避免动态 Worker 请求计费。
//
// 路径策略（与主站约定一致）：
...
var SITE_AVATAR = "https://ker.520pro.top/awa.jpg";
...
/** <title> 拼接：`标题 | 夏之`（对齐主仓 formatTitle） */
function seoTitle(t) {
...
function buildPostSeoHtml(post, bodyHtml) {
  ...
  var description = post.description || post.title + " —— 来自夏之的博客文章。";
  ...
  var ld = {
    ...
    inLanguage: "zh-CN",
    author: { "@type": "Person", name: "夏之", url: MAIN_URL, image: SITE_AVATAR },
