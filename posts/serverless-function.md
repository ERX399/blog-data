...
举个不恰当的例子就比如你正在观看的这个 [博客](https://520pro.top) ，首先我将源码上传到 [边缘安全加速平台 EO Pages_腾讯云](https://cloud.tencent.com/document/product/1552/118260) ，再经由平台构建出最终的HTML页面，然后再在平台上绑定域名，直接访问就可以了
