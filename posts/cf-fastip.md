...
> [!tip]
> 所有优选一个域名即可，无需两个域名。如： `s.520pro.top` 和 `s-s.520pro.top` 即可完成优选
##### 未优选
...
最后写一条解析指向优选域名 `fast-r2.520pro.top CNAME cf.090227.xyz`
...
当一个域名被SaaS到一个已经在Cloudflare的域名后，它就完整受益所有Cloudflare服务。如我将 umami.acofork.com SaaS 到 520pro.top，我就可以在 520pro.top 里为 umami.acofork.com 写规则了：
...
最后写一条 `umami.520pro.top` CNAME **你自己的优选域名** 的DNS记录即可
